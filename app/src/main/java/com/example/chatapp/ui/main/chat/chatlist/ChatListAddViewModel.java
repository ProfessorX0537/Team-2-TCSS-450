...
public class ChatListAddViewModel extends AndroidViewModel {

    private MutableLiveData<JSONObject> mResponse;

    public ChatListAddViewModel(@NonNull Application application) {
        super(application);
    ...
    public void requestNewChatRoom(String name, int memberid, String jwt) {
